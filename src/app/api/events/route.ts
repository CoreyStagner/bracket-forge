...
export async function GET(request) {
  try {
    const events = [
      { id: 1001, name: 'Stooges BAG', gamesSupported: [1006], tables: [], location: 'Stooges', description: 'A fun event for all!', startDate: new Date('2023-10-01T10:00:00Z'), endDate: new Date('2023-10-01T18:00:00Z') },
    ];
